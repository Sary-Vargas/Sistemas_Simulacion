...
class ReglaLineal:
    """Clase para implementar el autómata celular lineal"""
    
    def __init__(self, c0, num_generaciones):
        """
        Inicializa el autómata celular lineal
        c0: Estado inicial
        num_generaciones: Número de generaciones a calcular
        
        Regla: Si en la vecindad tenemos a un 1, la célula es 1
               En otro caso es 0
        """
        self.c0 = c0
    ...
    def aplicar_regla(self, izq, centro, der):
        """
        Aplica la regla lineal a tres células
        Regla: Si en la vecindad tenemos a un 1, la célula es 1
               En otro caso es 0
        """
        if izq != der:
...
class InterfazReglaLineal:
    """Interfaz gráfica para el autómata celular lineal"""
    
    def __init__(self, root, main_window=None):
        self.root = root
        self.main_window = main_window
        self.root.title("Autómata Celular Lineal")
    ...
    def crear_interfaz(self):
        ...
        # Título
        titulo = ttk.Label(main_frame, text="AUTÓMATA CELULAR LINEAL", 
                          font=('Arial', 18, 'bold'))
        titulo.pack(pady=15)
        ...
        # C0 - Estado inicial
        ttk.Label(entrada_frame, text="C0 (Estado inicial - ej: 00100):", 
        ...
        self.entry_c0.insert(0, "00100")  # Valor por defecto
    ...
    def generar_automata(self):
        ...
        try:
            ...
            self.automata = ReglaLineal(c0, num_generaciones)
            ...
            messagebox.showinfo("Éxito", f"Autómata Lineal generado con {num_generaciones} generaciones")
    ...
    def exportar_excel(self):
        ...
        try:
            ...
            filename = f"regla_lineal_automata_{timestamp}.xlsx"
            
            with pd.ExcelWriter(filename, engine='openpyxl') as writer:
                # Exportar datos
                self.df_resultados.to_excel(writer, sheet_name='Regla Lineal', index=False)
                
                # Obtener worksheet para formato
                workbook = writer.book
                worksheet = writer.sheets['Regla Lineal']
