...
class Regla90:
    """Clase para implementar el autómata celular Regla 90"""
    ...
    def __init__(self, c0, num_generaciones):
        ...
        self.generaciones = []
        # Regla 90: 01011010 en binario = 90 en decimal
        self.regla = {
            '111': '0',
            '110': '1',
            '101': '0',
    ...
    def aplicar_regla(self, izq, centro, der):
        """Aplica la regla 90 a tres células"""
...
class InterfazRegla90:
    """Interfaz gráfica para el autómata celular Regla 90"""
    
    def __init__(self, root, main_window=None):
        self.root = root
        self.main_window = main_window
        self.root.title("Autómata Celular - Regla 90")
    ...
    def crear_interfaz(self):
        ...
        # Título
        titulo = ttk.Label(main_frame, text="AUTÓMATA CELULAR - REGLA 90", 
                          font=('Arial', 18, 'bold'))
        titulo.pack(pady=15)
        
        # Información sobre la Regla 90
        info_frame = ttk.LabelFrame(main_frame, text="Información", padding="10")
        info_frame.pack(fill='x', pady=10)
        
        info_text = """La Regla 90 es un autómata celular elemental que genera el triángulo de Sierpinski.
Se caracteriza por producir patrones fractales a partir de condiciones iniciales simples.

Regla 90: 111→0  110→1  101→0  100→1  011→1  010→0  001→1  000→0"""
        ...
        # C0 - Estado inicial
        ttk.Label(entrada_frame, text="C0 (Estado inicial - ej: 00010000):", 
        ...
        self.entry_c0.insert(0, "00010000")  # Valor por defecto
        ...
        self.entry_c.insert(0, "15")  # Valor por defecto
    ...
    def generar_automata(self):
        ...
        try:
            ...
            self.automata = Regla90(c0, num_generaciones)
            ...
            messagebox.showinfo("Éxito", f"Autómata Regla 90 generado con {num_generaciones} generaciones")
    ...
    def exportar_excel(self):
        ...
        try:
            ...
            filename = f"regla90_automata_{timestamp}.xlsx"
            
            with pd.ExcelWriter(filename, engine='openpyxl') as writer:
                # Exportar datos
                self.df_resultados.to_excel(writer, sheet_name='Regla 90', index=False)
                
                # Obtener worksheet para formato
                workbook = writer.book
                worksheet = writer.sheets['Regla 90']
    ...
    def limpiar_campos(self):
        ...
        self.entry_c0.insert(0, "00010000")
