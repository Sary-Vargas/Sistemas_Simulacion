...
from prueba_medias import PruebaMediasApp     # ✅ ventana de medias
from prueba_varianza import PruebaVarianzaApp # ✅ ventana de varianza
...
class Clase1App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Clase 1 - Método de los Cuadrados Medios")
